...
public class MainActivity extends AppCompatActivity {
    ...
    public void controlar(View v) {
        ...
        if (valor==num) {
            Toast notificacion=Toast.makeText(this,"Has logrado recordar el número ingresado.",Toast.LENGTH_LONG);
            notificacion.show();
        }
        else {
            Toast notificacion=Toast.makeText(this,"Lo lamento no es el numero que se ingreso.", Toast.LENGTH_LONG);
            notificacion.show();
        }
    }
}
